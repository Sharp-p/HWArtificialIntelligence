...
# --- DEFINIZIONE ISTANZE DI TEST ---
# Qui inseriamo le istanze commentate nel tuo file a_star.py
test_cases = [
    {
        "name": "EASY_1",
        "state": [
...
# Lista per raccogliere i dati da salvare in CSV/Excel
data_records = []

# Header della tabella in console
print(f"\n{'=' * 95}")
print(
...
for case in test_cases:
    ...
    # Eseguiamo A*
    # Nota: A* in Python potrebbe essere molto lento su istanze grandi.
    # In uno scenario reale, metteremmo un timeout qui.
    try:
        # a_star ora ritorna (solution, metrics)
    ...
    # solve_with_pddl ora ritorna solo le metriche
...
# --- ESPORTAZIONE CSV ---
# Utile per creare grafici nel report finale
